    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="relative">
          ...
          <ContentEditableInput placeholder="Buscar anotações..." className="pl-9" value={busca} onChange={setBusca} />
        </div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-[380px] p-0 overflow-hidden rounded-2xl border-border/50 bg-card/95 backdrop-blur-xl shadow-2xl shadow-primary/5">
          ...
          <div className="px-5 pb-5 space-y-3">
            <ContentEditableInput placeholder="Título" value={form.titulo} onChange={(v) => setForm({ ...form, titulo: v })} className="h-9 text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30" />
            <ContentEditableInput placeholder="Matéria (opcional)" value={form.materia} onChange={(v) => setForm({ ...form, materia: v })} className="h-9 text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30" />
            <ContentEditableInput placeholder="Conteúdo" value={form.conteudo} onChange={(v) => setForm({ ...form, conteudo: v })} multiline className="text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30 min-h-[120px]" />
            <ContentEditableInput placeholder="Tags (separadas por vírgula)" value={form.tags} onChange={(v) => setForm({ ...form, tags: v })} className="h-9 text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30" />
