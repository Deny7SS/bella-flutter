  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto flex flex-col h-[calc(100dvh-2rem)] overflow-x-hidden w-full min-w-0">
        ...
        <Dialog open={showProfile} onOpenChange={setShowProfile}>
          <DialogContent className="max-w-[300px] p-0 overflow-hidden border-border rounded-2xl">
            ...
            <div className="px-5 py-4">
              <p className="text-[9px] font-mono text-muted-foreground uppercase tracking-widest mb-1.5">Recado</p>
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" style={{ minHeight: 0 }}>
          <div className="space-y-6 pb-4">
            ...
            <AnimatePresence>
              {messages.map((msg, i) => (
                ...
                >
                  {msg.role === "assistant" ? (
                    <div className="min-w-0 w-full group/msg">
                    ...
                    <div className="max-w-[85%] min-w-0 bg-primary text-primary-foreground rounded-2xl px-4 py-2">
        ...
        {/* Input */}
        <div className="pt-2 pb-1 border-t border-border/20 shrink-0">
          <div className="flex items-end gap-2 rounded-2xl border border-border/20 bg-background/60 backdrop-blur-sm px-4 py-2 transition-all focus-within:border-primary/30 focus-within:bg-background/80 focus-within:shadow-[0_0_0_1px_hsl(var(--primary)/0.15)]">
            <div
              ref={inputRef}
              ...
              onInput={(e) => setInput((e.currentTarget as HTMLDivElement).textContent || "")}
              onKeyDown={(e) => {
              ...
              className={[
                "flex-1 min-h-[20px] max-h-[120px] overflow-y-auto text-[13px] leading-relaxed",
            ...
            <motion.button
              ...
              onClick={send}
              animate={input.trim() && !isLoading ? { scale: 1, opacity: 1 } : { scale: 0.85, opacity: 0.3 }}
