      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-[340px] p-0 overflow-hidden rounded-2xl border-border/50 bg-card/95 backdrop-blur-xl shadow-2xl shadow-primary/5">
          ...
          <div className="px-5 pb-5 space-y-3">
            <ContentEditableInput placeholder="Título da tarefa" value={form.titulo} onChange={(v) => setForm({ ...form, titulo: v })} className="h-9 text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30" />
            <ContentEditableInput placeholder="Matéria" value={form.materia} onChange={(v) => setForm({ ...form, materia: v })} className="h-9 text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30" />
            ...
            <ContentEditableInput placeholder="Horário (ex: 08:00)" value={form.horario} onChange={(v) => setForm({ ...form, horario: v })} className="h-9 text-sm bg-secondary/30 border-border/50 focus-visible:ring-primary/30" />
